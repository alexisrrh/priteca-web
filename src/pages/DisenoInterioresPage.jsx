...
export function DisenoInterioresPage() {
      ...
      <section className="px-6 pb-16">
        <div className="mx-auto max-w-7xl">
          <p className="mb-4 text-xs uppercase tracking-[0.35em] text-neutral-500">
            Proyectos / Diseño de interiores
          </p>
          ...
          <p className="mt-8 max-w-2xl text-lg leading-8 text-neutral-600">
            Propuestas visuales para transformar hogares, negocios y espacios
            comerciales con acabados modernos y funcionales.
          </p>
        </div>
      </section>
        ...
        <div className="mx-auto grid max-w-7xl grid-cols-1 gap-4 md:grid-cols-3">
          {images.map((img) => (
            ...
            >
              <img
                src={img}
                alt="Proyecto de diseño de interiores"
